...
@interface WidgetRss : NSObject <UITextFieldDelegate, UIActionSheetDelegate>
...
@property (nonatomic, strong) NSString *currentRssFeed;
@property (nonatomic) NSInteger rssUpdateIntervalInMins;
